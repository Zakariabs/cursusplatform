                ...
                <div class="p-6">
                    <form action="{{ route('faq.update', $faq) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="question" name="question" type="text" class="block mt-1 w-full" :value="old('question', $faq->question)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="answer" name="answer" rows="4" class="block mt-1 w-full rounded-md border-gray-300" required>{{ old('answer', $faq->answer) }}</textarea>

                ...
                <div class="p-6">
                    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="10" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm" required></textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="publish_date" type="date" name="publish_date" class="block mt-1" required />

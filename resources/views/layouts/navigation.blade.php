            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    @if (auth()->user()->is_admin)
                        <x-nav-link :href="route('admin.users')" :active="request()->routeIs('admin.*')" class="mr-4">
                            {{ __('Admin') }}
                        </x-nav-link>
                    @endif
                ...
                @else
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="text-sm bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Registreren</a>
                    </div>
                @endauth
            </div>
